...
cb_ft_model = "babbage:ft-vibrant-data-labs-2023-05-30-00-38-12"
cd_ft_model = "babbage:ft-vibrant-data-labs-2023-06-15-03-03-12"

#process text
#eliminate extra spaces
#truncate entries longer than max tokens (or chunking?)

EMBEDDING_CTX_LENGTH = 2030
EMBEDDING_ENCODING = 'p50k_base'
...
if __name__ == "__main__":
    ...
    predictions = generate_predictions(df_cft, 3, column_text, '/Users/larareichmann/Workspace/VDL/climate-landscape/data/preds_test.json', model = cd_ft_model)
